...
namespace Mummybot.Structs
{
    public struct LogMessage
    {
        ...
        /// <summary>
        /// GuildId of the guild where the message came from
        /// </summary>
        /// <returns>
        /// no clue
        /// </returns>
        ...
        public LogMessage(LogSeverity severity, string source, string message, Exception exception = null, CachedGuild guild = null)
        {
            Severity = severity;
            Source = source;
            Message = message;

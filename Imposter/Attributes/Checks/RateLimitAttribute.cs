...
namespace Mummybot.Attributes.Checks
{
    ...
    public sealed class RatelimitAttribute : MummyCheckBase
    {
        public override string Name { get => "Ratelimit"; }
        ...
        {
            if (_noLimitForAdmins && context.User is CachedMember gu && gu.Permissions.Administrator)
